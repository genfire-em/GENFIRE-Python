...
_pkg_config = {
    'pyqt_bin_dir':      '/usr/local/Cellar/pyqt/4.11.4/bin',
    'pyqt_config_args':  '--confirm-license --bindir=/usr/local/Cellar/pyqt/4.11.4/bin --destdir=/usr/local/Cellar/pyqt/4.11.4/lib/python2.7/site-packages --sipdir=/usr/local/Cellar/pyqt/4.11.4/share/sip',
    'pyqt_mod_dir':      '/usr/local/Cellar/pyqt/4.11.4/lib/python2.7/site-packages/PyQt4',
    ...
    'pyqt_sip_dir':      '/usr/local/Cellar/pyqt/4.11.4/share/sip',
    ...
    'qt_archdata_dir':   '/usr/local/opt/qt',
    'qt_data_dir':       '/usr/local/opt/qt',
    'qt_dir':            '/usr/local/opt/qt',
    'qt_edition':        'free',
    'qt_framework':      1,
    'qt_inc_dir':        '/usr/local/opt/qt/include',
    'qt_lib_dir':        '/usr/local/opt/qt/lib',
    'qt_threaded':       1,
    'qt_version':        0x040807,
    'qt_winconfig':      'shared'
}
...
_default_macros = {
    ...
    'INCDIR_QT':                '/usr/local/opt/qt/include',
    'INCDIR_X11':               '',
    ...
    'LIBDIR':                   '',
    'LIBDIR_OPENGL':            '',
    'LIBDIR_QT':                '/usr/local/opt/qt/lib',
    'LIBDIR_X11':               '',
    'LIBS':                     '',
    'LIBS_CONSOLE':             '',
    'LIBS_CORE':                '',
