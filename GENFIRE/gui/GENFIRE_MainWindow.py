...
class Ui_GENFIRE_MainWindow(object):
    def setupUi(self, GENFIRE_MainWindow):
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QtCore.QRect(0, 0, 799, 895))
        ...
        self.gridLayout_2.addWidget(self.btn_displayResults, 2, 3, 1, 1)
        ...
        self.gridLayout_2.addLayout(self.gridLayout_3, 0, 5, 5, 1)
        ...
        self.gridLayout_2.addWidget(self.lineEdit_oversamplingRatio, 2, 1, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.lineEdit_interpolationCutoffDistance, 4, 1, 1, 1)
