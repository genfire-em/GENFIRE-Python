...
class Ui_ProjectionCalculator(object):
    def setupUi(self, ProjectionCalculator):
        ...
        self.btn_saveProjection = QtGui.QPushButton(self.centralwidget)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Preferred, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.btn_saveProjection.sizePolicy().hasHeightForWidth())
        self.btn_saveProjection.setSizePolicy(sizePolicy)
        self.btn_saveProjection.setObjectName(_fromUtf8("btn_saveProjection"))
        self.gridLayout_2.addWidget(self.btn_saveProjection, 2, 5, 1, 1)
    ...
    def retranslateUi(self, ProjectionCalculator):
        ...
        self.btn_saveProjection.setText(_translate("ProjectionCalculator", "Save Current Projection", None))
