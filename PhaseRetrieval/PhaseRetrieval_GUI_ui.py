...
class Ui_ProjectionCalculator(object):
    def setupUi(self, ProjectionCalculator):
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(-3, -3, 711, 481))
        ...
        self.slder_contrastLow = QtGui.QSlider(self.layoutWidget)
        ...
        self.slder_contrastHigh = QtGui.QSlider(self.layoutWidget)
        ...
        self.lineEdit_contrastHigh = QtGui.QLineEdit(self.layoutWidget)
        ...
        self.lineEdit_contrastLow = QtGui.QLineEdit(self.layoutWidget)
