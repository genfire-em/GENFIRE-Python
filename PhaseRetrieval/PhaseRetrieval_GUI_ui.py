...
class Ui_ProjectionCalculator(object):
    def setupUi(self, ProjectionCalculator):
        ...
        ProjectionCalculator.resize(808, 483)
        self.centralwidget = QtGui.QWidget(ProjectionCalculator)
        self.centralwidget.setObjectName(_fromUtf8("centralwidget"))
        self.widget = QtGui.QWidget(self.centralwidget)
        self.widget.setGeometry(QtCore.QRect(10, 40, 698, 438))
        self.widget.setObjectName(_fromUtf8("widget"))
        self.gridLayout = QtGui.QGridLayout(self.widget)
        self.gridLayout.setObjectName(_fromUtf8("gridLayout"))
        self.slder_contrastLow = QtGui.QSlider(self.widget)
        ...
        self.gridLayout.addWidget(self.verticalSlider_BGlevel, 0, 6, 3, 1)
        ...
        self.gridLayout.addWidget(self.verticalSlider_satThresh, 0, 7, 3, 1)
        self.slder_contrastHigh = QtGui.QSlider(self.widget)
        ...
        self.gridLayout.addWidget(self.lineEdit_diffpatFile, 5, 2, 1, 2)
        self.btn_selectDiffpat = QtGui.QPushButton(self.widget)
        self.btn_selectDiffpat.setObjectName(_fromUtf8("btn_selectDiffpat"))
        self.gridLayout.addWidget(self.btn_selectDiffpat, 5, 6, 1, 1)
        self.btn_go = QtGui.QPushButton(self.widget)
        self.btn_go.setObjectName(_fromUtf8("btn_go"))
        self.gridLayout.addWidget(self.btn_go, 6, 1, 1, 2)
        self.checkBox_takeSqrt = QtGui.QCheckBox(self.widget)
        ...
        self.gridLayout.addWidget(self.checkBox_takeSqrt, 6, 6, 1, 2)
        self.line = QtGui.QFrame(self.widget)
        self.line.setFrameShape(QtGui.QFrame.HLine)
        self.line.setFrameShadow(QtGui.QFrame.Sunken)
        self.line.setObjectName(_fromUtf8("line"))
        self.gridLayout.addWidget(self.line, 7, 0, 2, 7)
        self.btn_refineCenter = QtGui.QPushButton(self.widget)
        self.btn_refineCenter.setObjectName(_fromUtf8("btn_refineCenter"))
        self.gridLayout.addWidget(self.btn_refineCenter, 8, 5, 2, 2)
        self.btn_savePattern = QtGui.QPushButton(self.widget)
        self.btn_savePattern.setObjectName(_fromUtf8("btn_savePattern"))
        self.gridLayout.addWidget(self.btn_savePattern, 10, 0, 1, 1)
        self.lineEdit_saveFilename = QtGui.QLineEdit(self.widget)
        self.lineEdit_saveFilename.setObjectName(_fromUtf8("lineEdit_saveFilename"))
        self.gridLayout.addWidget(self.lineEdit_saveFilename, 10, 1, 1, 1)
        self.lbl_BGfilename = QtGui.QLabel(self.widget)
        self.lbl_BGfilename.setObjectName(_fromUtf8("lbl_BGfilename"))
        self.gridLayout.addWidget(self.lbl_BGfilename, 10, 3, 1, 2)
        self.btn_BGfilename = QtGui.QPushButton(self.widget)
        self.btn_BGfilename.setObjectName(_fromUtf8("btn_BGfilename"))
        self.gridLayout.addWidget(self.btn_BGfilename, 10, 5, 1, 1)
        self.lineEdit_BGfilename = QtGui.QLineEdit(self.widget)
        self.lineEdit_BGfilename.setObjectName(_fromUtf8("lineEdit_BGfilename"))
        self.gridLayout.addWidget(self.lineEdit_BGfilename, 10, 6, 1, 2)
        self.verticalLayout_figure = QtGui.QVBoxLayout()
        self.verticalLayout_figure.setObjectName(_fromUtf8("verticalLayout_figure"))
        self.gridLayout.addLayout(self.verticalLayout_figure, 0, 1, 2, 2)
