...
class Ui_ProjectionCalculator(object):
    def setupUi(self, ProjectionCalculator):
        ...
        self.widget.setGeometry(QtCore.QRect(9, 9, 601, 284))
        ...
        self.btn_refineCenter.raise_()
        self.checkBox_takeSqrt.raise_()
        self.btn_savePattern.raise_()
        self.lineEdit_saveFilename.raise_()
