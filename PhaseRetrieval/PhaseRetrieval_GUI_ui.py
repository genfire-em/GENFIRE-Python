...
class Ui_ProjectionCalculator(object):
    def setupUi(self, ProjectionCalculator):
        ...
        self.widget.setGeometry(QtCore.QRect(9, 9, 671, 391))
        ...
        self.verticalSlider_BGlevel = QtGui.QSlider(self.widget)
        ...
        self.verticalSlider_satThresh = QtGui.QSlider(self.widget)
        ...
        self.btn_selectDiffpatl = QtGui.QPushButton(self.widget)
        self.btn_selectDiffpatl.setObjectName(_fromUtf8("btn_selectDiffpatl"))
        self.gridLayout.addWidget(self.btn_selectDiffpatl, 3, 4, 1, 1)
        self.line = QtGui.QFrame(self.widget)
        self.line.setFrameShape(QtGui.QFrame.HLine)
        self.line.setFrameShadow(QtGui.QFrame.Sunken)
        self.line.setObjectName(_fromUtf8("line"))
        self.gridLayout.addWidget(self.line, 4, 0, 2, 5)
        self.btn_go = QtGui.QPushButton(self.widget)
        ...
        ProjectionCalculator.setTabOrder(self.lineEdit_diffpatFile, self.btn_selectDiffpatl)
        ProjectionCalculator.setTabOrder(self.btn_selectDiffpatl, self.btn_go)
    ...
    def retranslateUi(self, ProjectionCalculator):
        ...
        self.lbl_diffpat.setText(_translate("ProjectionCalculator", "Diffraction Pattern", None))
        self.btn_selectDiffpatl.setText(_translate("ProjectionCalculator", "Browse", None))
